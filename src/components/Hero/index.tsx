      ...
      <section className="tw-flex tw-w-full tw-flex-col ">
        ...
        <section className="tw-flex tw-w-full tw-flex-col tw-gap-6 md:tw-flex-row">
          ...
          <article
            ...
            className="tw-group tw-flex tw-w-full tw-cursor-pointer tw-flex-col tw-items-center tw-justify-center tw-gap-2 tw-bg-gray-100 tw-px-10 tw-py-6 tw-transition-all tw-duration-200 tw-ease-in-out hover:tw-bg-gray-200 hover:tw-shadow-sm active:tw-scale-90 md:tw-w-2/3 xl:tw-flex-row"
          >
            <div>
              <Text
          ...
          <div className="tw-relative tw-flex tw-grow tw-flex-col tw-gap-6">
            ...
            <article
              ...
              className="tw-group tw-flex tw-h-full tw-w-full tw-cursor-pointer tw-flex-col tw-items-center tw-justify-between tw-gap-2 tw-bg-gray-100 tw-px-10 tw-py-6 tw-transition-all tw-duration-200 tw-ease-in-out hover:tw-bg-gray-200 hover:tw-shadow-sm active:tw-scale-90 lg:tw-flex-row lg:tw-items-stretch"
            >
