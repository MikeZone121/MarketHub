...
function ProductGrid({ products, isLoading }: { products?: ProductModel[]; isLoading: boolean }) {
  return (
    <div className="tw-m-auto tw-mx-auto tw-my-4 tw-grid tw-w-full tw-grid-cols-1 tw-place-items-center tw-items-stretch tw-justify-items-center tw-gap-6 md:tw-auto-cols-min  lg:tw-grid-cols-2 xl:tw-grid-cols-4">
      {isLoading
